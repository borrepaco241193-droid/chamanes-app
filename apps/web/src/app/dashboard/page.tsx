...
export default function DashboardPage() {
  ...
  // Map nested backend stats to flat values for display
      ...
      {(pendingPayments > 0 || openWorkOrders > 0) && (
        <div className="card p-5">
          ...
          <div className="space-y-2">
            {pendingPayments > 0 && (
              <Link href="/dashboard/payments" className="flex items-center gap-3 p-3 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition-colors">
            ...
            {openWorkOrders > 0 && (
              <Link href="/dashboard/workorders" className="flex items-center gap-3 p-3 bg-orange-50 rounded-lg hover:bg-orange-100 transition-colors">
